...
describe.skip('Parse should: ', () => {
  ...
  it('return a forEach if passed a filename', () => {
    ...
    app.parse
      .getCall(0)
      .returned(sinon.match.same(['test-styl/test2.styl'].forEach));
  });
  ...
  it('return a forEach if passed a list of files', () => {
    ...
    app.parse
      .getCall(1)
      .returned(
        sinon.match.same(['test-styl/test2.styl, styl/test.styl'].forEach)
      );
  });
  ...
  it('handle empty or one line files fine', () => {
    ...
    app.parse
      .getCall(2)
      .returned(sinon.match.same(['test-styl/oneLine.styl'].forEach));
  });
