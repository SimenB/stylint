 ...
 */
module.exports = {
	blocks: 'never', // check for @block when defining blocks
	brackets: 'always', // check for { or }, unless used in a hash
	colons: false, // check for unecessary colons @TODO make jscs
	colors: false, // check for hex colors used without variables
	commaSpace: 'never', // check for spaces after commas (0, 0, 0, .18) @TODO make jscs
	commentSpace: false, // check for space after line comment @TODO make jscs
	...
	leadingZero: true, // find cases where 0.# is used, prefer .# @TODO make jscs
